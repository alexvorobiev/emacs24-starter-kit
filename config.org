...
#+begin_src emacs-lisp
  ...
  (setq TransUnion-doc-latex-class
        '("TransUnion-doc"
  ...
  \\setkomafont{section}{\\color{TUgreen}\\sffamily\\bfseries\\Large} 
  ...
  \\setfootwidth{paper}
  \\cohead[]{
    \\includegraphics[width=7.75in]{/cygdrive/c/Users/avorobi/Documents/TransUnionLogo.png}
  }
  \\pagestyle{scrplain}
  ...
  (add-to-list 'org-latex-classes TransUnion-doc-latex-class)
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-latex-packages-alist '("" "relsize"))
  (add-to-list 'org-latex-packages-alist '("automark,nouppercase" "scrpage2"))
